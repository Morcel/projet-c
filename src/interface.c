...
create_acceuilw (void)
{
  ...
  gtk_widget_set_size_request (fixed1, 282, -1);

  button2 = gtk_button_new ();
  gtk_widget_show (button2);
  gtk_fixed_put (GTK_FIXED (fixed1), button2, 416, 232);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), button1, 712, 536);
  ...
  image22 = create_pixmap (acceuilw, ";nrr.jpeg");
  gtk_widget_show (image22);
  gtk_fixed_put (GTK_FIXED (fixed1), image22, 48, 296);
  gtk_widget_set_size_request (image22, 624, 360);
...
create_gestionw (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), entry3w, 488, 176);
  gtk_widget_set_size_request (entry3w, 312, 35);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry3w), 8226);

  entry5w = gtk_entry_new ();
  gtk_widget_show (entry5w);
  gtk_fixed_put (GTK_FIXED (fixed3), entry5w, 488, 120);
  gtk_widget_set_size_request (entry5w, 312, 35);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry5w), 8226);

  yawmia = gtk_calendar_new ();
  gtk_widget_show (yawmia);
  gtk_fixed_put (GTK_FIXED (fixed3), yawmia, 680, 408);
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), label10w, 800, 160);
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), label7w, 800, 232);
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), label8w, 800, 296);
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), combobox1w, 488, 248);
  gtk_widget_set_size_request (combobox1w, 320, 40);
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), label11w, 24, 200);
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), label35w, 32, 120);
  gtk_widget_set_size_request (label35w, 264, 56);
  gtk_label_set_use_markup (GTK_LABEL (label35w), TRUE);

  button3 = gtk_button_new ();
  gtk_widget_show (button3);
  gtk_fixed_put (GTK_FIXED (fixed3), button3, 136, 640);
  gtk_widget_set_size_request (button3, 328, 48);
  ...
  gtk_fixed_put (GTK_FIXED (fixed4), entry8w, 472, 320);
  gtk_widget_set_size_request (entry8w, 432, 40);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry8w), 8226);

  entry9w = gtk_entry_new ();
  gtk_widget_show (entry9w);
  gtk_fixed_put (GTK_FIXED (fixed4), entry9w, 472, 264);
  gtk_widget_set_size_request (entry9w, 432, 40);
  ...
  gtk_fixed_put (GTK_FIXED (fixed4), combobox3w, 472, 152);
  gtk_widget_set_size_request (combobox3w, 432, 40);
  ...
  gtk_fixed_put (GTK_FIXED (fixed4), label37w, 464, 80);
  gtk_widget_set_size_request (label37w, 296, 56);
  gtk_label_set_use_markup (GTK_LABEL (label37w), TRUE);

  label36w = gtk_label_new (_("<span foreground=\"red\" ><b>Modifier troupeaux de ID :</b></span>"));
  gtk_widget_show (label36w);
  gtk_fixed_put (GTK_FIXED (fixed4), label36w, 0, 96);
  gtk_widget_set_size_request (label36w, 216, 64);
  gtk_label_set_use_markup (GTK_LABEL (label36w), TRUE);

  button4w = gtk_button_new ();
  gtk_fixed_put (GTK_FIXED (fixed4), button4w, 704, 464);
  gtk_widget_set_size_request (button4w, 288, 48);
  ...
  label22w = gtk_label_new (_("<span foreground=\"blue\"><b>Modifier</b></span>"));
  ...
  gtk_fixed_put (GTK_FIXED (fixed6), bmodifier, 528, 600);
  gtk_widget_set_size_request (bmodifier, 256, 40);
  ...
  gtk_fixed_put (GTK_FIXED (fixed6), bafficher12, 792, 544);
  gtk_widget_set_size_request (bafficher12, 192, 48);
  ...
  gtk_fixed_put (GTK_FIXED (fixed6), scrolledwindow2, 0, 0);
  gtk_widget_set_size_request (scrolledwindow2, 1000, 528);
  ...
  gtk_fixed_put (GTK_FIXED (fixed6), bsupprimer, 792, 600);
  gtk_widget_set_size_request (bsupprimer, 192, 40);
  ...
  label31w = gtk_label_new (_("<span foreground=\"blue\"><b>Rechercher</b></span>"));
  ...
  label54 = gtk_label_new_with_mnemonic (_(" le type \303\240 calculer :"));
  ...
  gtk_fixed_put (GTK_FIXED (fixed7), validert, 752, 136);
  ...
  gtk_fixed_put (GTK_FIXED (fixed7), comboboxchoix, 280, 64);
  gtk_widget_set_size_request (comboboxchoix, 592, 48);
  ...
  image25 = create_pixmap (gestionw, NULL);
  gtk_widget_show (image25);
  gtk_fixed_put (GTK_FIXED (fixed7), image25, 328, 352);
  gtk_widget_set_size_request (image25, 21, 21);

  image23 = create_pixmap (gestionw, "mouton.27930.gif");
  gtk_widget_show (image23);
  gtk_fixed_put (GTK_FIXED (fixed7), image23, 432, 312);
  gtk_widget_set_size_request (image23, 21, 21);

  label52 = gtk_label_new_with_mnemonic (_(" <span foreground=\"blue\"><b>nombre de troupeaux</b></span>"));
  ...
  gtk_fixed_put (GTK_FIXED (fixed2), button8, 728, 728);
  gtk_widget_set_size_request (button8, 256, 48);
  ...
  gtk_fixed_put (GTK_FIXED (fixed2), button7w, 488, 728);
  gtk_widget_set_size_request (button7w, 232, 48);
  ...
  GLADE_HOOKUP_OBJECT (gestionw, image25, "image25");
  GLADE_HOOKUP_OBJECT (gestionw, image23, "image23");
